<template>
  <div>
        <el-table :data="yybctableData.rows" @selection-change="handleSelectionChange" height="300" style="margin-top: 20px">
            ...
            <el-table-column prop="mname" label="开始属性"></el-table-column>
            <el-table-column prop="mname" label="开始时间"></el-table-column>
            <el-table-column prop="mname" label="结束属性"></el-table-column>
        ...
        <div class="block clearfix">
            ...
            :current-page="yybctableData.page" prev-text='上一页' next-text='下一页'
            :page-sizes="[10, 20, 30, 40]"  :page-size="10" layout=" prev, pager, next, total, jumper, sizes"
            :total="yybctableData.total">
            </el-pagination>
        </div>
        <!-- 按钮 -->
