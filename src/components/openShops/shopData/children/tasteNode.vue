<template>
  <div>
        <el-table :data="kwbztableData.rows" @selection-change="handleSelectionChange" height="300" style="margin-top: 20px">
            <el-table-column type="index"></el-table-column>
            <el-table-column type="selection"></el-table-column>
            <el-table-column prop="name" label="状态|全部Y">
        ...
        <div class="block clearfix">
            ...
            :current-page="kwbztableData.page" prev-text='上一页' next-text='下一页'
            :page-sizes="[10, 20, 30, 40]"  :page-size="10" layout=" prev, pager, next, total, jumper, sizes"
            :total="kwbztableData.total">
            </el-pagination>
        </div>
        <!-- 按钮 -->
