<template>
  <div>
        <el-table :data="dyjtableData.rows" @selection-change="handleSelectionChange" height="300" style="margin-top: 20px">
            <el-table-column type="index"></el-table-column>
            <el-table-column type="selection"></el-table-column>
            <el-table-column prop="mname" label="状态">
                <template slot-scope="scope">
                    <span>{{scope.row.openFlag==="1"?"停用":"有效"}}</span>
                </template>
            </el-table-column>
            <el-table-column prop="mname" label="名称"></el-table-column>
            <el-table-column prop="mname" label="打印机说明"></el-table-column>
            <el-table-column prop="mname" label="端口"></el-table-column>
            <el-table-column prop="mname" label="地址"></el-table-column>
            <el-table-column prop="mname" label="是否地理打印机"></el-table-column>
        ...
        <div class="block clearfix">
            ...
            :current-page="dyjtableData.page" prev-text='上一页' next-text='下一页'
            :page-sizes="[10, 20, 30, 40]"  :page-size="10" layout=" prev, pager, next, total, jumper, sizes"
            :total="dyjtableData.total">
            </el-pagination>
        </div>
        <!-- 按钮 -->
