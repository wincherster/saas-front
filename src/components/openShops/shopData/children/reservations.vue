<template>
  <div>
        <el-table :data="cwtableData.rows" @selection-change="handleSelectionChange" height="300" style="margin-top: 20px">
            ...
            <el-table-column prop="mname" label="餐位类型"></el-table-column>
            <el-table-column prop="mname" label="营业区域"></el-table-column>
            <el-table-column prop="mname" label="服务费类型"></el-table-column>
            <el-table-column prop="mname" label="是否单桌营业"></el-table-column>
        ...
        <div class="block clearfix">
            ...
            :current-page="cwtableData.page" prev-text='上一页' next-text='下一页'
            :page-sizes="[10, 20, 30, 40]"  :page-size="10" layout=" prev, pager, next, total, jumper, sizes"
            :total="cwtableData.total">
            </el-pagination>
        </div>
        <!-- 按钮 -->
