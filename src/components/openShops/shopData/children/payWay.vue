<template>
  <div>
        <el-table :data="fkfstableData.rows" @selection-change="handleSelectionChange" height="300" style="margin-top: 20px">
            ...
            <el-table-column prop="mname" label="付款类型"></el-table-column>
            <el-table-column prop="mname" label="是否记收入"></el-table-column>
            <el-table-column prop="mname" label="是否积分"></el-table-column>
            <el-table-column prop="mname" label="是否可开发票"></el-table-column>
            <el-table-column prop="mname" label="是否预收款"></el-table-column>
            <el-table-column prop="mname" label="备注"></el-table-column>
            <el-table-column prop="mname" label="操作" fixed="right">
                <template slot-scope="scope">
        ...
        <div class="block clearfix">
            ...
            :current-page="fkfstableData.page" prev-text='上一页' next-text='下一页'
            :page-sizes="[10, 20, 30, 40]"  :page-size="10" layout=" prev, pager, next, total, jumper, sizes"
            :total="fkfstableData.total">
            </el-pagination>
        </div>
        <!-- 按钮 -->
