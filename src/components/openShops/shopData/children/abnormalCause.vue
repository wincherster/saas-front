<template>
  <div>
        <el-table :data="ycyytableData.rows" @selection-change="handleSelectionChange" height="300" style="margin-top: 20px">
        ...
        <div class="block clearfix">
            ...
            :current-page="ycyytableData.page" prev-text='上一页' next-text='下一页'
            :page-sizes="[10, 20, 30, 40]"  :page-size="10" layout=" prev, pager, next, total, jumper, sizes"
            :total="ycyytableData.total">
            </el-pagination>
        </div>
        <!-- 按钮 -->
